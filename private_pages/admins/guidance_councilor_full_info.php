        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              ...
              <?php  $get_logs = get_all_log_dates_by_gc_id($_GET['guidance_councilor']);  
              ...
              <div class="active tab-pane" id="timeline">
                ...
                <ul class="timeline timeline-inverse">
                  ...
                  <?php 
                    //log items by date
                  $get_logs_by_date = get_all_logs_by_date_and_gc_id($_GET['guidance_councilor'],$log_details['log_date']);
